...
# fit the HMM
hmm <- fitHMM(data=Data_less_fine_final,
              nbStates=N,
              dist=dist,
              DM=DM,
              beta0=beta0,
...
Data_less_fine_final$viterbi <- viterbi(hmm)
Data_less_fine_final$p_catch <- stateProbs(hmm)[,4]
Data_less_fine_final$p_no_fish <- stateProbs(hmm)[,5]
Data_less_fine_final$p_fish <- stateProbs(hmm)[,6]